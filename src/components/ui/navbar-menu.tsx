          ...
          {active === item && children && (
            <div className="absolute top-[calc(100%_+_1.2rem)] left-1/2 transform -translate-x-1/2 pt-4">
              <motion.div
                ...
                className="bg-black dark:bg-black backdrop-blur-sm rounded-2xl overflow-hidden border-black/[0.2] dark:border-white/[0.2] shadow-xl"
              >
                <motion.div
...
// Updated HoveredLink type
export const HoveredLink = ({
  children,
  ...rest
}: {
  children: React.ReactNode;
  [key: string]: unknown; // Specify proper type instead of any
}) => {
  return (
    <Link href={""}
      {...rest}
